 ...
 */
class ProductServices extends \BackendBundle\Entity\ProductServices implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductServices $proxy) {
