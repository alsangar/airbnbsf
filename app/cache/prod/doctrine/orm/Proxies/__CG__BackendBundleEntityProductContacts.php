 ...
 */
class ProductContacts extends \BackendBundle\Entity\ProductContacts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductContacts $proxy) {
