 ...
 */
class ProductDescription extends \BackendBundle\Entity\ProductDescription implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductDescription $proxy) {
